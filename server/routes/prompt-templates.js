...
- **绝对不要把镜头切成 1-2 秒的碎镜**；只有当某镜头有较长台词时，才按台词字数(约每秒 3 字)适当加长 duration。
- 节奏（快/中/慢）只用来决定**镜头的内容密度与能量**，以及（当用户选择"自动镜头数"时）总镜头数量：快节奏段落镜头更紧凑信息更密，平稳段落更舒缓。无论快慢，单镜时长都围绕基准时长，不要靠缩短单镜来表现快节奏。
