...
export const LoginPage: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-[#0a0a0a] text-neutral-200 p-4">
            <form
                onSubmit={submit}
                className="w-full max-w-sm bg-[#161616] border border-neutral-800 rounded-2xl shadow-2xl p-7 flex flex-col gap-4"
            >
                <div className="flex flex-col items-center gap-2 mb-1">
                    <img src="/logo.png" alt="Magical Canvas" className="w-12 h-12 rounded-xl object-contain bg-black/20" />
                    <h1 className="text-lg font-semibold text-white">魔法画布</h1>
                    <p className="text-xs text-neutral-500">请登录以继续</p>
                </div>
